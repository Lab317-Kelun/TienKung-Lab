...
class EventCfg:
    ...
    add_joint_default_pos: EventTerm | None = None
    ...
    base_com: EventTerm | None = None
    pelvis_com: EventTerm | None = None
    knee_link_com: EventTerm | None = None
    robot_joint_stiffness_and_damping: EventTerm | None = None
...
@configclass
class ActionNoiseCfg:
    enable: bool = False
    noise_scale: float = 0.02


@configclass
class ActuationOffsetCfg:
    enable: bool = False
...
class DomainRandCfg:
    ...
    action_noise: ActionNoiseCfg = ActionNoiseCfg()
    actuation_offset: ActuationOffsetCfg = ActuationOffsetCfg()
