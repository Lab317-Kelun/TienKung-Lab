...
@configclass
class Robot1_6WalkWithSensorFlatEnvCfg:
    ...
    #     actuation_offset=ActuationOffsetCfg(enable=False, offset_range=(-0.05, 0.05)),
    # )
    sim: SimCfg = SimCfg(dt=0.005, decimation=4, physx=PhysxCfg(gpu_max_rigid_patch_count=10 * 2**15))


@configclass
class Robot1_6WalkWithSensorAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
