...
class LiteRewardCfg:
    ...
    # Robot1_6 doesn't have arms, so this reward term is disabled
...
@configclass
class Robot1_6RunWithSensorFlatEnvCfg:
...
@configclass
class Robot1_6RunWithSensorAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
