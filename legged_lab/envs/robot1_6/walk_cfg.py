...
from legged_lab.envs.robot1_6.velocity_cfg import Robot1_6VelocityRewardCfg
...
@configclass
class Robot1_6WalkFlatEnvCfg:
    amp_motion_files_display = ["legged_lab/envs/robot1_6/datasets/motion_visualization/tiankung_walk.txt"]
    device: str = "cuda:0"
...
@configclass
class Robot1_6WalkAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    ...
    experiment_name = "robot1_6_walk"
    run_name = ""
    logger = "wandb"
    neptune_project = "robot1_6_walk"
    wandb_project = "robot1_6_walk"  # 项目名称
    resume = False
    load_run = ".*"
    ...
    # amp parameter
    amp_reward_coef = 0.0
    amp_motion_files = ["legged_lab/envs/robot1_6/datasets/motion_amp_expert/tiankung_walk.txt"]
...
@configclass
class Robot1_6WalkAmpFlatEnvCfg(Robot1_6WalkFlatEnvCfg):
    robot: RobotCfg = RobotCfg(
        actor_obs_history_length=10,
        critic_obs_history_length=10,
        action_scale=0.25,
...
@configclass
class Robot1_6WalkAmpAgentCfg(Robot1_6WalkAgentCfg):
    algorithm = RslRlPpoAlgorithmCfg(
        class_name="AMPPPO",
        value_loss_coef=1.0,
        use_clipped_value_loss=True,
    ...
    runner_class_name = "AmpOnPolicyRunner"
    experiment_name = "robot1_6_walk_amp"
